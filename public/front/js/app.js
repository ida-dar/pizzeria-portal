...
const app = {
  ...
  initHomePage: function(){
    ...
    // thisApp.homePage.carousel = homeContainer.querySelector(select.widgets.carousel.wrapper);

    // thisApp.homePage.carouselWidget = new Carousel(thisApp.homePage.carousel);
